...
End Sub
    ...
    Public Function lptestproblemhasknowntarget(ByVal p As lptestproblem) As Boolean
        Try
    ...
    Public Function lptestproblemgettargetf(ByVal p As lptestproblem) As Double
        Try
    ...
    Public Function lptestproblemgetn(ByVal p As lptestproblem) As Integer
        Try
    ...
    Public Function lptestproblemgetm(ByVal p As lptestproblem) As Integer
        Try
    ...
    Public Sub rbfsetalgothinplatespline(ByVal s As rbfmodel, ByVal lambdav As Double)
        Try
    ...
    Public Sub rbfsetalgothinplatespline(ByVal s As rbfmodel)
        Try
    ...
    Public Sub rbfsetalgomultiquadricmanual(ByVal s As rbfmodel, ByVal alpha As Double, ByVal lambdav As Double)
        Try
    ...
    Public Sub rbfsetalgomultiquadricmanual(ByVal s As rbfmodel, ByVal alpha As Double)
        Try
    ...
    Public Sub rbfsetalgomultiquadricauto(ByVal s As rbfmodel, ByVal lambdav As Double)
        Try
    ...
    Public Sub rbfsetalgomultiquadricauto(ByVal s As rbfmodel)
        Try
    ...
    Public Sub rbfsetalgobiharmonic(ByVal s As rbfmodel, ByVal lambdav As Double)
        Try
    ...
    Public Sub rbfsetalgobiharmonic(ByVal s As rbfmodel)
        Try
    ...
    Public Sub rbfdiff1(ByVal s As rbfmodel, ByVal x0 As Double, ByRef y As Double, ByRef dy0 As Double)
        Try
    ...
    Public Sub rbfdiff2(ByVal s As rbfmodel, ByVal x0 As Double, ByVal x1 As Double, ByRef y As Double, ByRef dy0 As Double, ByRef dy1 As Double)
        Try
    ...
    Public Sub rbfdiff3(ByVal s As rbfmodel, ByVal x0 As Double, ByVal x1 As Double, ByVal x2 As Double, ByRef y As Double, ByRef dy0 As Double, ByRef dy1 As Double, ByRef dy2 As Double)
        Try
    ...
    Public Sub rbfdiff(ByVal s As rbfmodel, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double)
        Try
    ...
    Public Sub rbfhess(ByVal s As rbfmodel, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double, ByRef d2y() As Double)
        Try
    ...
    Public Sub rbfdiffbuf(ByVal s As rbfmodel, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double)
        Try
    ...
    Public Sub rbfhessbuf(ByVal s As rbfmodel, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double, ByRef d2y() As Double)
        Try
    ...
    Public Sub rbftsdiffbuf(ByVal s As rbfmodel, ByVal buf As rbfcalcbuffer, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double)
        Try
    ...
    Public Sub rbftshessbuf(ByVal s As rbfmodel, ByVal buf As rbfcalcbuffer, ByVal x() As Double, ByRef y() As Double, ByRef dy() As Double, ByRef d2y() As Double)
        Try
