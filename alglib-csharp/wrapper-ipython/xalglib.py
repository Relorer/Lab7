...
if curdir=="":
    curdir = "."
_net_candidates = []
_net_candidates.append(os.path.join(os.path.relpath(curdir),"alglib319gpl_net2.dll"))
_net_candidates.append(os.path.join(sys.prefix,"alglib319gpl_net2.dll"))
_net_candidates.append(os.path.join(os.sep+"usr","local","alglib319gpl_net2.dll"))
